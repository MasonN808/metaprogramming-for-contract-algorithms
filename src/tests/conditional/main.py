...
if __name__ == "__main__":
    ...
    test.find_utility_and_allocations(allocation_type="initial", initial_allocation="uniform", verbose=False)
    test.find_utility_and_allocations(allocation_type="optimal", initial_allocation="uniform", verbose=False)
