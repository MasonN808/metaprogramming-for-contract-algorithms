...
#     # ----------------------------------------------------------------------------------------
#     # for node
#     node_4 = Node(4, [], [], expression_type="for")

#     # for nodes
#     node_3 = Node(3, [node_4], [], expression_type="contract")
#     node_2 = Node(2, [node_3], [], expression_type="contract")
#     node_1 = Node(1, [node_2], [], expression_type="contract")

#     node_1 = Node(1, [node_1], [], expression_type="contract", is_conditional_root=True)
...
#     # ----------------------------------------------------------------------------------------
#     #   Define the for subprogram
#     # ----------------------------------------------------------------------------------------
#     # Define the graph object
#     for_subtree = DirectedAcyclicGraph(nodes_inner, node_inner_4)
