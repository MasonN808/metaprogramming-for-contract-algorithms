...
if __name__ == "__main__":
    ...
    # performance_profile_velocities = [[.0001, 3, 7]]
    ...
    for ppv in tqdm(performance_profile_velocities, desc='Progress Bar'):
        ...
        test.save_eu_time_data(eu_time_list=eu_time, eu_file_path="src/tests/small-func/data/eu_data3.txt", time_file_path="src/tests/small-func/data/time_data3.txt", node_indicies=node_indicies_list)
